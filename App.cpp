...
float x1 = .01 * (rand() % 100 + 1);
float x2 = -.01 * (rand() % 100 + 1);
float x3 = .01 * (rand() % 100 + 1);
float x4 = -.01 * (rand() % 100 + 1);
float x5 = .01 * (rand() % 100 + 1);
float x6 = -.01 * (rand() % 100 + 1);
float x7 = .01 * (rand() % 100 + 1);
float x8 = -.01 * (rand() % 100 + 1);
float x9 = .01 * (rand() % 100 + 1);
bool contains = true;
...
App::App(int argc, char** argv): GlutApp(argc, argv){
	...
	doodle = new AnimatedRect("doodle.png", 1, 1, 100, x5 -0.1, -0.4, 0.2, 0.2);
